...
if __name__ == "__main__":
    ...
    hashtags = ['codnation', 'callofduty', 'cwl', 'twitch', 'blackout',
                'killcam', 'codclips', 'blackops', 'freeforall', 'twitchclips', 'blackoutgame', 'xbox',
                'battleroyale', 'ps4', 'gamingmemes', 'bo4', 'blackops4', 'callofdutyblackops4']
